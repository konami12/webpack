...
const CONFIG_WEBPACK = {
    ...
    output: {
        ...
        filename: "bundle.js",
        publicPath: "./dist/", // indica donde buscara los archivos
    },
    //carga de modulos
    module: {
        rules : [
            ...
            //Soporte para fuentes
            {
                ...
                use: {
                    loader: "url-loader",
                    options: {
                        limit: 5000000,//esto nos permite indicar el size maximo de la imagen
                    }
                }
            },
            {
                ...
                use: {
                    ...
                    options: {
                        ...
                        // name: coloca el nombre original del archivo.
                        // hash: cada ves que el archivo se transpile genera un hash unico.
                        // ext: coloca la extencion real del archivo.
                        name: "videos/[name].[hash].[ext]",// este parametro indica la ruta de salida.
                    },
                }
            },
        ],
